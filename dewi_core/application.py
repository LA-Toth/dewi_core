...
class Application:
    ...
    def run(self, args: typing.Optional[typing.List[str]] = None):
        single_command_mode = self._command_class and len(self._command_classes) == 1
        ...
        def app_run(ctx: click.Context, *args, **kwargs):
            app_context.add_cmd_args('__main__', ctx.params)
            app_context.invoked_subcommand = ctx.invoked_subcommand
        ...
        if single_command_mode:
            ...
            app_run = click.group(self._program_name, cls=AppGroup)(app_run)
